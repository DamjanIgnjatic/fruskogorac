...
class CustomAdminLogin
{
    ...
    public function __construct()
    {
        ...
        $this->fields = [
            'login' => [
                'title' => __('Custom admin login URL', 'fruskogorac'),
                'description' => __('Set a custom admin login URL to protect your login page', 'fruskogorac'),
                'slug' => 'aeva'
            ],
            'redirect' => [
                'title' => __('Custom admin redirect URL', 'fruskogorac'),
                'description' => __('Set a custom admin 404 redirect URL if someone tryes to access wp-admin', 'fruskogorac'),
                'slug' => '404'
            ]
        ];
    ...
    {
        echo '<p>' . __('Set a custom admin login and 404 redirect URL to protect your login page.', 'fruskogorac') . '</p>';
    }
