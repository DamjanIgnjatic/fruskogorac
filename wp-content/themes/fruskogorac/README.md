...
Replace all of the "Fruskogorac" string with your websites name and the "fruskogorac" string with your lowercased websites name without any whitespace (fore example instead of the string "The Theme" use "thetheme").
